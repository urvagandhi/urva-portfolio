      ...
      <main className="flex w-full flex-col items-center justify-center text-dark dark:text-light pt-24 pb-16">
        <Layout className="pt-16">
          ...
          <div className="text-lg text-dark/75 dark:text-light/75 text-center mb-4 max-w-2xl mx-auto leading-relaxed">
            Privacy and data protection guidelines for{" "}
            <strong>
              Urva Gandhi&apos;s Developer Portfolio &amp; API Infrastructure
            </strong>
            .
          </div>
          ...
          <div className="space-y-8 w-full mb-16">
            ...
            <div className="relative p-8 sm:p-6 xs:p-4 rounded-3xl border border-dark/10 bg-light/80 dark:border-light/10 dark:bg-dark/80 backdrop-blur-md shadow-xl overflow-hidden">
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <div className="text-xs text-dark/60 dark:text-light/60">
                    Platform ownership &amp; privacy commitment
                  </div>
                </div>
              </div>
              ...
              <div className="text-sm text-dark/80 dark:text-light/80 leading-relaxed font-medium">
                ...
                owner&quot;) operates the developer portfolio hosted at{" "}
                <code className="font-mono bg-dark/10 dark:bg-light/10 px-2 py-0.5 rounded text-xs font-bold text-primary dark:text-primaryDark">
                  https://urvagandhi.tech
                </code>{" "}
                (and its permanent mirror{" "}
                <code className="font-mono bg-dark/10 dark:bg-light/10 px-2 py-0.5 rounded text-xs font-bold">
                  https://urvagandhi-portfolio.vercel.app
                </code>
                ). I am committed to respecting your privacy and protecting any
                information processed while visiting this site or using its API
                endpoints.
              </div>
            </div>
            ...
            <div className="relative p-8 sm:p-6 xs:p-4 rounded-3xl border border-dark/10 bg-light/80 dark:border-light/10 dark:bg-dark/80 backdrop-blur-md shadow-xl overflow-hidden">
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <div className="text-xs text-dark/60 dark:text-light/60">
                    Privacy-first aggregate performance monitoring
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-3 text-sm text-dark/80 dark:text-light/80 leading-relaxed font-medium">
                <div>
                  This portfolio website uses <strong>Vercel Analytics</strong>{" "}
                  and <strong>Vercel Speed Insights</strong> to collect
                  aggregated, privacy-friendly performance telemetry (such as
                  page load times, Core Web Vitals, and generalized geographic
                  metrics).
                </div>
                ...
                <div className="space-y-2 pt-2">
                  ...
                  <div className="flex items-center gap-2 text-dark dark:text-light">
                    <CheckCircle2 className="w-4 h-4 text-emerald-500 flex-shrink-0" />
                    <span>
                      No cross-site tracking, advertising pixels, or invasive
                      session recorders are utilized.
                    </span>
                  </div>
                  <div className="flex items-center gap-2 text-dark dark:text-light">
                    <CheckCircle2 className="w-4 h-4 text-emerald-500 flex-shrink-0" />
                    <span>
                      IP addresses are anonymized before telemetry processing by
                      Vercel.
                    </span>
                  </div>
                </div>
            ...
            <div className="relative p-8 sm:p-6 xs:p-4 rounded-3xl border border-dark/10 bg-light/80 dark:border-light/10 dark:bg-dark/80 backdrop-blur-md shadow-xl overflow-hidden">
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <div className="text-xs text-dark/60 dark:text-light/60">
                    Zero persistent tracking cookies
                  </div>
                </div>
              </div>

              <div className="text-sm text-dark/80 dark:text-light/80 leading-relaxed font-medium">
                This site does NOT use persistent tracking cookies. Local
                storage is only utilized locally within your browser to remember
                your visual theme preference (Dark Mode vs Light Mode).
              </div>
            </div>
            ...
            <div className="relative p-8 sm:p-6 xs:p-4 rounded-3xl border border-dark/10 bg-light/80 dark:border-light/10 dark:bg-dark/80 backdrop-blur-md shadow-xl overflow-hidden">
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-dark dark:text-light">
                    4. API &amp; MCP Tool Processing
                  </h2>
                  <div className="text-xs text-dark/60 dark:text-light/60">
                    Data processing transparency for developer endpoints
                  </div>
                </div>
              </div>

              <div className="text-sm text-dark/80 dark:text-light/80 leading-relaxed font-medium">
                Programmatic requests to public REST endpoints (
                <code className="font-mono bg-dark/10 dark:bg-light/10 px-2 py-0.5 rounded text-xs font-bold text-primary dark:text-primaryDark">
                  /api/*
                </code>
                ) and the Model Context Protocol endpoint (
                <code className="font-mono bg-dark/10 dark:bg-light/10 px-2 py-0.5 rounded text-xs font-bold text-primary dark:text-primaryDark">
                  /api/mcp
                </code>
                ) process request metadata solely to fulfill response payloads
                and enforce standard rate limits. No request payloads are sold,
            ...
            <div className="p-8 sm:p-6 xs:p-4 rounded-3xl border border-dark/10 bg-light/80 dark:border-light/10 dark:bg-dark/80 backdrop-blur-md shadow-xl flex flex-row items-center sm:flex-col sm:items-start justify-between gap-6 flex-wrap">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-xs text-dark/70 dark:text-light/70">
