...
import TypewriterText from "@/components/shared/TypewriterText.js";
import AnimatedDownloadButton from "@/components/shared/AnimatedDownloadButton.js";
import Education from "@/components/sections/Education.js";
import Experience from "@/components/sections/Experience.js";
import Internship from "@/components/sections/Internship.js";
import HireMe from "@/components/layout/HireMe.js";
import { GithubIcon, LinkArrow } from "@/components/shared/Icons.js";
...
const GithubGraph = dynamic(
  () => import("@/components/charts/GithubGraph.js"),
  {
    ssr: false,
    loading: () => (
      <div className="h-[200px] w-full animate-pulse rounded-xl bg-dark/5 dark:bg-light/10" />
    ),
  },
);
const LeetcodeGraph = dynamic(
  () => import("@/components/charts/LeetcodeGraph.js"),
  {
    ssr: false,
    loading: () => (
      <div className="h-[200px] w-full animate-pulse rounded-xl bg-dark/5 dark:bg-light/10" />
...
import CodingProfiles from "@/components/coding/CodingProfiles.js";
        ...
        {tech && (
          <div className="my-3 flex flex-wrap gap-2">
            {tech.split(",").map((item, index) => (
              <span
                key={index}
                className="rounded-lg bg-dark/5 dark:bg-light/10 px-3 py-1 text-xs font-semibold text-dark/80 dark:text-light/80 border border-dark/5 dark:border-light/5 shadow-sm"
              >
                {item.trim()}
              </span>
            ))}
      ...
      <div>
        ...
        <div className="flex w-full items-center justify-between mt-3 pt-3 border-t border-dark/10 dark:border-light/10">
          ...
          <Link
            href={github}
            target="_blank"
            className="w-6 text-dark dark:text-light hover:scale-110 transition-transform"
            aria-label={`View ${title} on GitHub`}
          >
            <GithubIcon />
          </Link>
...
import ProjectsShowcase from "@/components/sections/ProjectsShowcase.js";
...
export default function Home() {
  ...
  useEffect(() => {
    fetch("/api/leetcode?username=urva_gandhi")
        ...
        if (!data.error) {
          const totalSolved =
            data.submitStats?.acSubmissionNum?.find(
              (q) => q.difficulty === "All",
            )?.count || data.submitStats?.acSubmissionNum?.[0]?.count;
          if (totalSolved) {
      ...
      .catch((err) =>
        console.error("Failed to fetch Leetcode count for index page", err),
      );
  }, []);
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="keywords"
          content="Urva Gandhi, Urva Gandhi portfolio, full-stack developer, software engineer, Nirma University, React developer, Spring Boot developer, machine learning engineer, hackathon winner, Java developer, Python developer, web developer portfolio, computer science student"
        />
        ...
        <meta
          property="og:title"
          content="Urva Gandhi | Software Developer Portfolio"
        />
        <meta
          property="og:description"
          content="Software developer specializing in Java, Spring Boot, and Machine Learning. 3x Hackathon Winner across 500+ teams. View projects, skills, and experience."
        />
        <meta
          property="og:image"
        ...
        <meta
          ...
          content="Urva Gandhi — Full-Stack Developer"
        />
        ...
        <meta
          ...
          content="Full-stack developer specializing in React.js, Spring Boot, and Machine Learning. Explore projects and experience."
        />
        <meta
          name="twitter:image"
          content="https://urvagandhi.tech/images/profile/urva.png"
      ...
      <section
        id="home"
        className="flex min-h-screen items-center text-dark dark:text-light pt-24"
      >
          ...
          <div className="flex w-full items-center justify-between lg:flex-col">
            ...
            <div className="flex w-1/2 flex-col items-center self-center lg:w-full lg:text-center">
              ...
              <p className="my-4 text-base font-medium md:text-sm sm:!text-xs">
                I don&apos;t just write code — I architect solutions. Full-stack
                developer × ML enthusiast × Hackathon winner. Obsessed with
      ...
      <section
        id="about"
        className="relative w-full dark:text-light border-t-2 border-solid border-dark dark:border-light overflow-hidden"
      >
          ...
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
            <div className="col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:order-2 md:col-span-8">
              ...
              <p className="font-medium">
                Hi, I&apos;m <strong>Urva Gandhi</strong>, a Computer Science
                undergraduate at Nirma University. I&apos;m a{" "}
                <strong>passionate software engineer</strong> who thrives at the
                intersection of
                <strong> backend architecture</strong> and{" "}
                <strong>artificial intelligence</strong>. My journey involves
                transforming complex ideas into elegant, production-ready
                solutions.
              </p>
              <p className="my-4 font-medium">
                Currently, I&apos;m building <strong>CoinTrack</strong> (Unified
                financial analytics) and
                <strong> CodeGuardian</strong> (AI-powered secure code
                analysis). I&apos;m deep diving into Data Structures &
                Algorithms mastery, LLM Application Development & RAG systems,
                and High-Performance Backend & System Design.
              </p>
              <p className="font-medium">
                Open to collaborating on real-time financial data pipelines, ML
                deployment workflows & MLOps, and turning Hackathon prototypes
                into Production systems. I&apos;ve solved{" "}
                <Link
            ...
            <div className="col-span-2 flex flex-col items-end justify-between xl:col-span-8 xl:flex-row xl:items-center md:order-3">
              <Link
                href="https://leetcode.com/u/urva_gandhi"
                target="_blank"
                className="flex flex-col items-end justify-center xl:items-center group"
              >
      ...
      <section
        id="contributions"
        className="w-full mb-16 dark:text-light border-t-2 border-solid border-dark dark:border-light"
      >
      ...
      >
        ...
        <p>
          ...
          8.83/10). He is a production-level Java backend developer and 3x
          Hackathon Winner specializing in Spring Boot, Microservices, Hexagonal
          Architecture, and Multi-Agent AI systems.
        </p>

        <h2>Who This Site Is For</h2>
        <p>
          Technical recruiters, software engineering leads, hiring managers, and
          autonomous AI agents seeking backend software engineers, Spring Boot
          developers, and AI systems consultants.
        </p>
        ...
        <ul>
          ...
          <li>
            Open for Spring Boot &amp; Microservices contract development.
          </li>
          <li>Open for AI Systems consulting &amp; software internships.</li>
          <li>
            Public REST API &amp; MCP Server endpoints: Free ($0) open access
            with standard 100 req/min rate limit. Zero recruitment platform fee.
          </li>
        </ul>
        ...
        <ul>
          <li>
            Academic Record: CGPA 8.83 / 10 in B.Tech CSE (Minor: Adaptive AI)
            at Institute of Technology, Nirma University.
          </li>
          <li>
            3x Hackathon Winner: 1st Place Health AI Hackathon 2025 (140+
            teams), Track Runner-Up HACKaMINeD 2026 (400+ teams), 2nd Runner-Up
            Odoo Hackathon 2026.
          </li>
          <li>
            Verified DSA Stats: Solved 300+ LeetCode problems (Rating 1637, Top
            19.46%). Active on Codeforces and CodeChef.
          </li>
          <li>
            Featured Projects: CoinTrack (Java Spring Boot Hexagonal
            Architecture), FleetFlow (Prisma/PostgreSQL), Agent Paperpal (CrewAI
            multi-agent formatter), RWEsearch (Healthcare analytics).
          </li>
        </ul>

        <h2>Contact Information</h2>
        <p>
          Email: 23bce078@nirmauni.ac.in | urvagandhi24@gmail.com | Phone:
          +91-8866241204
        </p>
      </section>
    </>
