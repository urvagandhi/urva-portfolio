...
const SwaggerEndpoint = ({ 
  ...
  const executeApi = async () => {
    ...
    try {
      ...
      setResponse(JSON.stringify({ error: "Failed to execute request", details: err.message }, null, 2));
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className={`rounded-2xl border transition-all duration-300 overflow-hidden shadow-md ${
      isGet 
      ...
      >
        <div className="flex items-center gap-3 min-w-0">
          <span className={`px-3 py-1 rounded-md font-mono font-extrabold text-xs tracking-wider text-white shadow-sm flex-shrink-0 ${
            isGet ? "bg-emerald-600 dark:bg-emerald-500" : "bg-blue-600 dark:bg-blue-500"
          }`}>
            {method}
          </span>
      ...
      {isOpen && (
        <div className="p-6 border-t border-dark/10 dark:border-light/10 bg-light/90 dark:bg-dark/90 space-y-6 text-sm">
          ...
          <div className="space-y-1.5">
            ...
            <pre suppressHydrationWarning={true} className="p-3 bg-dark text-emerald-400 rounded-xl text-xs font-mono overflow-x-auto border border-dark/20">
              GET {fullUrl}
            </pre>
          </div>
            ...
            <div className="space-y-3 pt-4 border-t border-dark/10 dark:border-light/10">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <span className="font-bold text-xs uppercase text-dark/70 dark:text-light/70">Server Response:</span>
                  <span className={`px-2.5 py-0.5 rounded-md font-mono text-xs font-bold ${
                    responseStatus === 200 ? "bg-emerald-500/20 text-emerald-600 dark:text-emerald-400" : "bg-red-500/20 text-red-500"
                  }`}>
                ...
                {response && (
                  ...
                  >
                    ...
                    <span>{copied ? "Copied JSON!" : "Copy Response JSON"}</span>
                  </button>
                )}
              </div>
      ...
      <main className="flex w-full flex-col items-center justify-center text-dark dark:text-light pt-24 pb-16">
        <Layout className="pt-16">
          <div className="w-full flex justify-center mb-12 sm:mb-8">
            <SectionHeading title="Developer Portal" subTitle="SWAGGER API EXPLORER" theme="blue" />
          </div>
          ...
          <div className="max-w-5xl mx-auto w-full">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 w-full mb-16">
              ...
              >
                <BorderBeam size={160} duration={10} delay={0} colorFrom="#58E6D9" colorTo="#8B5CF6" />
                <div>
                  ...
                  <div className="text-xs text-dark/70 dark:text-light/70 mb-4 leading-relaxed">
                    Standard OpenAPI specification describing all REST API endpoints.
                  </div>
                </div>
              ...
              <Link 
                ...
                className="relative p-6 rounded-3xl border border-dark/10 bg-light/80 dark:border-light/10 dark:bg-dark/80 backdrop-blur-md shadow-xl flex flex-col justify-between overflow-hidden cursor-pointer group hover:-translate-y-1 hover:border-primary/50 dark:hover:border-primaryDark/50 transition-all duration-300"
              >
                <BorderBeam size={160} duration={10} delay={3} colorFrom="#8B5CF6" colorTo="#58E6D9" />
                <div>
                  <div className="flex items-center justify-between mb-4">
                    <div className="p-3 rounded-2xl bg-primary/10 dark:bg-primaryDark/20 text-primary dark:text-primaryDark group-hover:scale-110 transition-transform">
                  ...
                  <div className="text-xs text-dark/70 dark:text-light/70 mb-4 leading-relaxed">
                    First-party Model Context Protocol manifest &amp; tool endpoints.
                  </div>
                </div>
                <div className="flex items-center gap-1.5 text-xs font-bold text-primary dark:text-primaryDark group-hover:underline">
              ...
              <Link 
                ...
                className="relative p-6 rounded-3xl border border-dark/10 bg-light/80 dark:border-light/10 dark:bg-dark/80 backdrop-blur-md shadow-xl flex flex-col justify-between overflow-hidden cursor-pointer group hover:-translate-y-1 hover:border-primary/50 dark:hover:border-primaryDark/50 transition-all duration-300"
              >
                <BorderBeam size={160} duration={10} delay={6} colorFrom="#58E6D9" colorTo="#8B5CF6" />
                <div>
                  <div className="flex items-center justify-between mb-4">
                    <div className="p-3 rounded-2xl bg-primary/10 dark:bg-primaryDark/20 text-primary dark:text-primaryDark group-hover:scale-110 transition-transform">
              ...
              <Link 
                ...
                className="relative p-6 rounded-3xl border border-dark/10 bg-light/80 dark:border-light/10 dark:bg-dark/80 backdrop-blur-md shadow-xl flex flex-col justify-between overflow-hidden cursor-pointer group hover:-translate-y-1 hover:border-primary/50 dark:hover:border-primaryDark/50 transition-all duration-300"
              >
                <BorderBeam size={160} duration={10} delay={9} colorFrom="#8B5CF6" colorTo="#58E6D9" />
                <div>
                  <div className="flex items-center justify-between mb-4">
                    <div className="p-3 rounded-2xl bg-primary/10 dark:bg-primaryDark/20 text-primary dark:text-primaryDark group-hover:scale-110 transition-transform">
            ...
            <div className="w-full mb-16">
              ...
              <div className="mt-4 p-4 rounded-2xl bg-amber-500/10 border border-amber-500/20 text-xs text-amber-700 dark:text-amber-300 font-medium flex items-center gap-2">
                <span className="font-bold uppercase tracking-wider px-2 py-0.5 rounded bg-amber-500/20 text-[10px]">Data Pipeline Note</span>
                <span>Statistics for platforms like GeeksforGeeks and HackerRank are extracted directly through web scraping.</span>
              </div>
            </div>
            ...
            <div className="w-full mb-16">
              ...
              <div className="p-8 rounded-3xl border border-dark/10 bg-light/80 dark:border-light/10 dark:bg-dark/80 backdrop-blur-md shadow-xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                  ...
                  >
                    <div className="flex items-center justify-between mb-1">
                      <h4 className="font-bold text-sm text-dark dark:text-light group-hover:text-primary dark:group-hover:text-primaryDark">MCP Manifest Endpoint</h4>
                    ...
                    <code suppressHydrationWarning={true} className="text-xs font-mono font-bold text-primary dark:text-primaryDark">
                  ...
                  >
                    <div className="flex items-center justify-between mb-1">
                      <h4 className="font-bold text-sm text-dark dark:text-light group-hover:text-primary dark:group-hover:text-primaryDark">MCP Tool Calling Endpoint</h4>
                      <ExternalLink className="w-3.5 h-3.5 text-dark/40 dark:text-light/40 group-hover:text-primary dark:group-hover:text-primaryDark" />
                    </div>
                    <code suppressHydrationWarning={true} className="text-xs font-mono font-bold text-primary dark:text-primaryDark">
                      POST {origin}/api/mcp
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs font-mono">
                  ...
                  <div className="p-3 rounded-xl bg-dark/5 dark:bg-light/5 border border-dark/10 dark:border-light/10">
                    <strong className="text-primary dark:text-primaryDark block mb-1">2. get_coding_stats</strong>
                    <span className="text-dark/75 dark:text-light/75 font-sans">Fetches verified statistics across LeetCode, Codeforces, CodeChef, GFG, HackerRank.</span>
                  </div>
                  <div className="p-3 rounded-xl bg-dark/5 dark:bg-light/5 border border-dark/10 dark:border-light/10">
                    <strong className="text-primary dark:text-primaryDark block mb-1">3. get_projects</strong>
                    <span className="text-dark/75 dark:text-light/75 font-sans">Fetches CoinTrack, FleetFlow, Agent Paperpal, RWEsearch metadata and code links.</span>
                  </div>
                  <div className="p-3 rounded-xl bg-dark/5 dark:bg-light/5 border border-dark/10 dark:border-light/10">
                    <strong className="text-primary dark:text-primaryDark block mb-1">4. get_contact_info</strong>
                    <span className="text-dark/75 dark:text-light/75 font-sans">Returns verified email channels, LinkedIn, GitHub, phone numbers, and address.</span>
                  </div>
                </div>
              </div>
            </div>
