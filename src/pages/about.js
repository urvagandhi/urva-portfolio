          ...
          <div className="grid w-full grid-cols-8 gap-16 lg:gap-10 sm:gap-8 md:grid-cols-1">
            ...
            <div className="col-span-5 flex flex-col items-start justify-start md:col-span-8">
              ...
              <p className="font-medium leading-relaxed mb-4 text-dark/80 dark:text-light/80 text-base">
                Hi, I&apos;m <strong>Urva Yogeshkumar Gandhi</strong>, a
                final-year Computer Science &amp; Engineering undergraduate at{" "}
                <strong>Institute of Technology, Nirma University</strong>{" "}
                (Minor: Adaptive AI, CGPA: 8.83/10). I specialize in
                production-level Java backend development, Spring Boot
                microservices, enterprise security architectures, and hands-on
                AI/ML engineering (multi-agent systems, NLP, predictive ML). I
                am a 3x national hackathon winner.
              </p>

              <p className="font-medium leading-relaxed mb-6 text-dark/80 dark:text-light/80 text-base">
                My core passion lies in the{" "}
                <strong>
                  Java ecosystem (Spring Boot, Spring Security, Microservices,
                  REST APIs, PostgreSQL, MongoDB, Docker, Hexagonal
                  Architecture)
                </strong>{" "}
                as well as{" "}
                <strong>
                  AI Systems (Multi-Agent Workflows with CrewAI, Google Gemini
                  API, Scikit-learn, TensorFlow)
                </strong>
                .
              </p>
              ...
              <div className="p-4 rounded-2xl bg-dark/5 dark:bg-light/5 border border-dark/10 dark:border-light/10 mb-6 w-full">
                <p className="font-medium leading-relaxed text-dark/80 dark:text-light/80 text-sm">
                  Worked as a{" "}
                  <strong>Backend Developer Intern at Kautilyam</strong> (04 May
                  2026 – 27 Jun 2026), contributing to scalable web
                  applications, business logic, data workflows, and MongoDB
                  integrations using Core Java, Spring Boot, and ReactJS.
                </p>
              </div>
              ...
              <ul className="space-y-3 font-medium text-dark/80 dark:text-light/80 mb-6 w-full text-sm">
                <li className="p-4 rounded-2xl bg-dark/5 dark:bg-light/5 border border-dark/10 dark:border-light/10">
                  <strong className="text-dark dark:text-light text-base block mb-1">
                    CoinTrack (Multi-Broker Finance Platform):
                  </strong>
                  Shipped a 45+ REST endpoint platform in Java &amp; Spring Boot
                  with hexagonal architecture, aggregating Zerodha, Angel One,
                  and Upstox portfolios into a real-time dashboard with Google
                  OAuth 2.0, mandatory TOTP 2FA, AES-256-GCM encryption, JWT
                  refresh rotation, and Caffeine caching.
                </li>
                <li className="p-4 rounded-2xl bg-dark/5 dark:bg-light/5 border border-dark/10 dark:border-light/10">
                  <strong className="text-dark dark:text-light text-base block mb-1">
                    FleetFlow (Fleet &amp; Logistics System):
                  </strong>
                  Built a fleet management platform with 30+ APIs, Socket.IO,
                  PostgreSQL, Prisma ORM, and Docker. Secured{" "}
                  <span className="text-primary dark:text-primaryDark font-bold">
                    2nd Runner-Up at Odoo x Gujarat Vidyapith Hackathon 2026
                  </span>
                  .
                </li>
                <li className="p-4 rounded-2xl bg-dark/5 dark:bg-light/5 border border-dark/10 dark:border-light/10">
                  <strong className="text-dark dark:text-light text-base block mb-1">
                    Agent Paperpal (Agentic AI Formatter):
                  </strong>
                  Built a multi-agent manuscript compliance system (CrewAI,
                  Google Gemini API, ReactJS). Won{" "}
                  <span className="text-primary dark:text-primaryDark font-bold">
                    Track Runner-Up at HACKaMINeD 2026
                  </span>{" "}
                  (400+ teams, 2300+ registrations).
                </li>
                <li className="p-4 rounded-2xl bg-dark/5 dark:bg-light/5 border border-dark/10 dark:border-light/10">
                  <strong className="text-dark dark:text-light text-base block mb-1">
                    RWEsearch (Healthcare Analytics):
                  </strong>
                  Built ML hospital readmission prediction pipelines (XGBoost,
                  Deep Learning) and Streamlit UI. Won{" "}
                  <span className="text-primary dark:text-primaryDark font-bold">
                    1st Place at Health AI Innovation Hackathon 2025
                  </span>{" "}
                  (140+ teams).
                </li>
              </ul>
              ...
              <p className="font-medium leading-relaxed text-dark/80 dark:text-light/80 text-sm">
                I have solved <strong>300+ DSA problems on LeetCode</strong>{" "}
                (Contest Rating 1637, Top 19.46%) and actively participate on
            ...
            <div className="col-span-3 flex flex-col items-center justify-start md:col-span-8">
              ...
              <div className="mt-8 w-full rounded-3xl border border-dark/10 bg-light/80 p-6 dark:border-light/10 dark:bg-dark/80 backdrop-blur-md text-sm space-y-3 shadow-xl">
                <div className="flex items-center gap-2 pb-2 border-b border-dark/10 dark:border-light/10">
                  ...
                  <h3 className="font-bold text-base text-dark dark:text-light">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    B.Tech CSE (Minor: Adaptive AI) • <strong>8.83 / 10</strong>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 pt-2 border-t border-dark/10 dark:border-light/10">
                  ...
                  <div className="space-y-1 font-mono text-xs min-w-0">
                    <div>
                      ...
                      <strong className="text-dark dark:text-light break-all">
                    ...
                    <div>
                      ...
                      <span className="text-dark/80 dark:text-light/80 break-all">
