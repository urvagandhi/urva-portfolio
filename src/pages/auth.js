      ...
      <main className="flex w-full flex-col items-center justify-center text-dark dark:text-light pt-24 pb-16">
        <Layout className="pt-16">
          <div className="w-full flex justify-center mb-12 sm:mb-8">
            <SectionHeading title="API Security" subTitle="POLICIES &amp; LIMITS" theme="emerald" />
          </div>
            ...
            <div className="space-y-8 w-full mb-16">
              ...
              <div className="relative p-8 sm:p-6 xs:p-4 rounded-3xl border border-dark/10 bg-light/80 dark:border-light/10 dark:bg-dark/80 backdrop-blur-md shadow-xl overflow-hidden">
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-dark dark:text-light">1. Authentication Model</h2>
                    <div className="text-xs text-dark/60 dark:text-light/60">Open-access architecture for developers &amp; AI agents</div>
                  </div>
                </div>

                <div className="space-y-3 text-sm text-dark/80 dark:text-light/80 leading-relaxed font-medium">
                  <div>
                    All public REST endpoints (<code className="font-mono bg-dark/10 dark:bg-light/10 px-2 py-1 rounded text-xs font-bold text-primary dark:text-primaryDark">/api/leetcode</code>, <code className="font-mono bg-dark/10 dark:bg-light/10 px-2 py-1 rounded text-xs font-bold text-primary dark:text-primaryDark">/api/codeforces</code>, <code className="font-mono bg-dark/10 dark:bg-light/10 px-2 py-1 rounded text-xs font-bold text-primary dark:text-primaryDark">/api/codechef</code>) and the MCP Server (<code className="font-mono bg-dark/10 dark:bg-light/10 px-2 py-1 rounded text-xs font-bold text-primary dark:text-primaryDark">/api/mcp</code>) are open-access.
                  </div>
                  <div className="flex items-center gap-2 text-emerald-600 dark:text-emerald-400 font-bold">
                    <CheckCircle2 className="w-4 h-4 flex-shrink-0" />
                    <span>No API key or Bearer token is required for standard requests or AI agent tool invocations.</span>
                  </div>
                </div>
              </div>
              ...
              <div className="relative p-8 sm:p-6 xs:p-4 rounded-3xl border border-dark/10 bg-light/80 dark:border-light/10 dark:bg-dark/80 backdrop-blur-md shadow-xl overflow-hidden">
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-dark dark:text-light">2. Rate Limiting &amp; Caching</h2>
                    <div className="text-xs text-dark/60 dark:text-light/60">Fair use quotas and server-side cache policy</div>
                  </div>
                </div>
                ...
                <div className="space-y-3 text-sm text-dark/80 dark:text-light/80 font-medium">
                  ...
                  <div className="grid grid-cols-3 xs:grid-cols-1 gap-4 pt-2">
                    ...
                    <div className="p-4 rounded-2xl bg-dark/5 dark:bg-light/5 border border-dark/10 dark:border-light/10">
                      <div className="text-xs font-bold text-dark/60 dark:text-light/60 mb-1">MCP Tool Limit</div>
                      <div className="text-lg font-bold text-dark dark:text-light">60 calls / min</div>
                    </div>
                    <div className="p-4 rounded-2xl bg-dark/5 dark:bg-light/5 border border-dark/10 dark:border-light/10">
                      <div className="text-xs font-bold text-dark/60 dark:text-light/60 mb-1">Response Cache</div>
                      <div className="text-lg font-bold text-dark dark:text-light">3600 sec TTL</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="relative p-8 sm:p-6 xs:p-4 rounded-3xl border border-dark/10 bg-light/80 dark:border-light/10 dark:bg-dark/80 backdrop-blur-md shadow-xl overflow-hidden">
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-dark dark:text-light">3. CORS &amp; Security Headers</h2>
                    <div className="text-xs text-dark/60 dark:text-light/60">Cross-origin resource sharing &amp; content negotiation</div>
                  </div>
                </div>

                <div className="space-y-3 text-sm text-dark/80 dark:text-light/80 font-medium">
                  <div>All API responses include standard CORS headers allowing safe cross-domain web &amp; agent queries:</div>
