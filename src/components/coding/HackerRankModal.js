...
import { useModalControls } from "@/components/hooks/useModalControls.js";
import {
  X,
  Award,
  Star,
...
const getBadgeIcon = (badgeName) => {
  ...
  if (nameLower.includes("java")) {
    return (
      <svg x="32.5" y="21" width="27" height="27" viewBox="0 0 73.24 98.75">
        ...
        />
        <path
          d="M21.343,58.14625a2.87287,2.87287,0,0,0,.42567,2.68149c1.97365,2.74012,8.96466,4.24876,19.686,4.24876H41.456c1.45271,0,2.98642-.02855,4.55736-.08486,17.14144-.61352,23.49925-5.95374,23.76155-6.18075a.80908.80908,0,0,0-.74275-1.39234C62.99511,59.06682,51.72236,59.652,43.90336,59.652c-8.74922,0-13.20493-.6303-14.29582-1.0957.55971-.76859,4.01211-2.14107,8.29019-2.98256a.80937.80937,0,0,0-.15623-1.60353C35.2338,53.9702,22.65762,54.17155,21.343,58.14625Z"
          transform="translate(-13.38209 -0.625)"
          fill="#1e293b"
        />
        <path
          d="M78.70179,52.64594a16.91173,16.91173,0,0,0-7.02939,1.84713.80961.80961,0,0,0,.3813,1.5233c.075,0,7.54165.06114,8.21786,4.32726.59906,3.68037-7.06468,9.64357-10.06827,11.63091a.80938.80938,0,0,0,.61527,1.46659c.71286-.15256,17.43673-3.83794,15.66848-13.57506C85.40831,53.89865,81.65773,52.64594,78.70179,52.64594Z"
          transform="translate(-13.38209 -0.625)"
          fill="#1e293b"
        />
        <path
          d="M67.23269,70.783a.8102.8102,0,0,0-.33116-.81141l-4.01-2.80878a.812.812,0,0,0-.67215-.1192A78.86966,78.86966,0,0,1,51.896,68.83267a71.65008,71.65008,0,0,1-7.8271.4141c-6.08663,0-10.06634-.71517-10.64592-1.23978-.07676-.14736-.05246-.21428-.03877-.2515a2.04153,2.04153,0,0,1,1.0334-.77843.80949.80949,0,0,0-.4708-1.54606c-4.02252.97072-5.98943,2.32815-5.84631,4.03448.2542,3.02538,7.26161,4.57819,13.18565,4.98861.85191.05825,1.77326.08775,2.73781.08775h.00154c9.85071,0,22.47915-3.09076,22.60529-3.1222A.80715.80715,0,0,0,67.23269,70.783Z"
          transform="translate(-13.38209 -0.625)"
          fill="#1e293b"
        />
        <path
          d="M37.00108,77.27581a.80937.80937,0,0,0-.46366-1.487c-.53907.01427-5.27484.228-5.60639,3.24313a3.13539,3.13539,0,0,0,.76744,2.44677c1.70035,2.01512,6.29031,3.21285,14.02965,3.66147.91556.055,1.84559.08255,2.76462.08255a42.18314,42.18314,0,0,0,16.74354-3.21189.80968.80968,0,0,0,.076-1.42281l-5.06769-3.09366a.81477.81477,0,0,0-.58691-.10164c-.032.00675-3.24969.67408-8.10561,1.33332a26.12612,26.12612,0,0,1-3.41961.18843c-4.85071,0-10.2461-.79251-11.28085-1.31152A.32454.32454,0,0,1,37.00108,77.27581Z"
          transform="translate(-13.38209 -0.625)"
          fill="#1e293b"
        />
        <path
          d="M43.907,94.52448c22.53778-.01909,34.6341-4.02715,36.96437-6.54933a2.79048,2.79048,0,0,0,.844-2.2888A3.53465,3.53465,0,0,0,80.1651,83.407a.81721.81721,0,0,0-1.05617.14369.8.8,0,0,0-.00521,1.05327c.14215.18284.22431.48893-.19133.90495-.93157.87-10.32729,3.511-25.97128,4.3045-2.143.11129-4.39072.168-6.68029.16837-14.00689,0-24.25781-1.91868-25.60347-3.03656C21.176,86.2,24.802,85.00936,28.658,84.33586a.8096.8096,0,0,0-.24745-1.59987c-.10878.01485-.47793.03684-.90534.06307-6.36244.38844-13.71489,1.25424-14.09851,4.53248a3.33615,3.33615,0,0,0,.88258,2.695c1.71829,1.93064,6.65715,4.49757,29.61693,4.49757Z"
          transform="translate(-13.38209 -0.625)"
          fill="#1e293b"
        />
        <path
          d="M85.29818,88.68588a.80853.80853,0,0,0-.93273.18361c-.033.03568-3.42154,3.57892-13.60977,5.65962-3.90044.78152-11.22184,1.17786-21.7609,1.17786-10.55874,0-20.606-.41544-20.70609-.41969a.80949.80949,0,0,0-.22161,1.5962A120.51319,120.51319,0,0,0,53.09774,99.375a116.67238,116.67238,0,0,0,19.97144-1.66737c11.83478-2.07471,12.66335-7.943,12.69286-8.19182A.80953.80953,0,0,0,85.29818,88.68588Z"
          transform="translate(-13.38209 -0.625)"
          fill="#1e293b"
        />
      </svg>
  ...
  if (nameLower.includes("python")) {
    return (
      ...
      >
        <path
          d="M12 2c5.522 0 10 4.477 10 10s-4.478 10-10 10S2 17.523 2 12 6.478 2 12 2zm0 3C8.134 5 5 8.134 5 12s3.134 7 7 7 7-3.134 7-7-3.134-7-7-7z"
          fill="#1e293b"
          opacity="0.15"
        />
        <path
          d="M11.75 6.25a2.75 2.75 0 0 0-2.75 2.75V11H12v1H9a2.75 2.75 0 0 0-2.75 2.75v1.5A2.75 2.75 0 0 0 9 19h2.75a2.75 2.75 0 0 0 2.75-2.75V14H12v-1h3a2.75 2.75 0 0 0 2.75-2.75V8.75A2.75 2.75 0 0 0 15 6h-3.25z"
          stroke="#1e293b"
          strokeWidth="1.8"
          strokeLinecap="round"
          strokeLinejoin="round"
  ...
  if (
    nameLower.includes("30 days of code") ||
    nameLower.includes("days") ||
...
const HackerRankBadge = ({ badge }) => {
  ...
  const progressText =
    solved !== undefined && totalChallenges !== undefined
  ...
  return (
    ...
    >
        ...
        >
          ...
          {Array.from({ length: Math.min(stars, 6) }).map((_, idx) => {
            ...
            const totalStarWidth =
              stars * starWidth + (stars - 1) * starSpacing;
      ...
      <div className="absolute bottom-full mb-2 scale-0 group-hover:scale-100 bg-dark dark:bg-light text-light dark:text-dark text-[11px] py-2 px-3 rounded-xl shadow-xl border border-solid border-dark/10 dark:border-light/10 transition-all duration-200 pointer-events-none z-30 flex flex-col items-center text-center w-40">
        <span className="font-extrabold text-green-600 dark:text-green-500 mb-0.5">
          {name}
        </span>
...
export const HackerRankModal = ({ show, onClose, data }) => {
  ...
  const avatar =
    profile.avatar ||
    "https://d1ce3iv5vajdy.cloudfront.net/hackerrank/assets/gravatar.jpg";
          ...
          >
            ...
            <div className="p-8 xs:p-4 pb-4 xs:pb-2 border-b border-solid border-dark/10 dark:border-light/10 flex flex-col md:gap-4 relative">
              ...
              <div className="flex items-center gap-4 sm:flex-col sm:items-start">
                <div className="relative w-20 h-20 xs:w-14 xs:h-14 rounded-2xl overflow-hidden border-2 border-solid border-green-500/50 shadow-md flex items-center justify-center bg-green-500/10">
                  {avatar ? (
              ...
              >
                {hrLoading ? (
                  <div className="flex flex-col items-center justify-center py-20 gap-4">
                    ...
                    <span className="text-sm font-bold text-dark/50 dark:text-light/50">
                      Fetching HackerRank Analytics...
                    </span>
                  </div>
                ) : (
                  <>
                      ...
                      >
                        ...
                        <div className="grid grid-cols-3 gap-4 sm:grid-cols-1">
                          <div className="border border-solid border-dark/10 dark:border-light/10 p-5 rounded-2xl bg-light dark:bg-dark flex flex-col items-center justify-center text-center group hover:scale-[1.02] hover:shadow-lg transition-all duration-300">
                            ...
                            <span className="text-xs font-bold text-dark/50 dark:text-light/50 uppercase tracking-wider mt-1">
                              Platform Level
                            </span>
                          </div>
                          <div className="border border-solid border-dark/10 dark:border-light/10 p-5 rounded-2xl bg-light dark:bg-dark flex flex-col items-center justify-center text-center group hover:scale-[1.02] hover:shadow-lg transition-all duration-300">
                        ...
                        <div className="border border-solid border-dark/10 dark:border-light/10 p-6 rounded-2xl bg-light dark:bg-dark space-y-4">
                          <h5 className="text-md font-bold border-b border-solid border-dark/10 dark:border-light/10 pb-2 flex items-center gap-2">
                            ...
                            HackerRank Performance Highlights
                          </h5>
                          <p className="text-sm leading-relaxed text-dark/80 dark:text-light/80">
                            Solving technical challenges across several
                            developer domains. Demonstrates strong coding
                            competency in core programming environments and
                            algorithms.
                          </p>
                          {skills.length > 0 && (
                            <div className="pt-2">
                              <div className="text-xs text-dark/50 dark:text-light/50 font-bold uppercase mb-2">
                              ...
                              <div className="flex flex-wrap gap-2">
                                {skills.map((skill, i) => (
                                  <span
                                    key={i}
                                    className="px-3 py-1 rounded-full text-xs font-semibold bg-dark/5 dark:bg-light/5 border border-solid border-dark/10 dark:border-light/10"
                                  >
                    ...
                    {activeTab === "badges" && (
                      ...
                      >
                        ...
                        <div className="border border-solid border-dark/10 dark:border-light/10 p-6 rounded-2xl bg-light dark:bg-dark flex flex-col items-center">
                          ...
                          {badges.length === 0 ? (
                            <span className="text-sm text-dark/50 dark:text-light/50 self-start">
                              No badges found.
                            </span>
                          ) : (
                        ...
                        <div className="border border-solid border-dark/10 dark:border-light/10 p-6 rounded-2xl bg-light dark:bg-dark">
                          <h5 className="text-md font-bold mb-4 border-b border-solid border-dark/10 dark:border-light/10 pb-2">
                            Domain Practice & Leaderboard Rankings
                          </h5>
                          {skills.length === 0 ? (
                            <span className="text-sm text-dark/50 dark:text-light/50">
                              No active domain rankings found.
                            </span>
                          ) : (
                            <div className="space-y-4">
                              {skills.map((skill, i) => (
                                <div
                                  key={i}
                                  className="flex items-center justify-between p-3 rounded-xl bg-dark/5 dark:bg-light/5 border border-solid border-dark/10 dark:border-light/10 flex-wrap gap-2"
                                >
