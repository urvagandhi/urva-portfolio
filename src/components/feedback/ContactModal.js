  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok && data.success) {
        ...
        setErrorMsg(
          data.error || "Failed to send message. Please try direct email.",
        );
      }
    } catch (err) {
            ...
            <div className="flex flex-col gap-6 px-1 sm:px-2">
              <div className="flex flex-col gap-1.5">
                ...
                <p className="text-sm sm:text-xs text-dark/70 dark:text-light/70">
                  Select your preferred channel to connect regarding roles or
                  proposals.
                </p>
              </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm sm:text-xs text-dark/60 dark:text-light/60 mt-1">
                      Submit a structured inquiry directly through the portfolio
                      server.
                    </p>
                  </div>
                </div>
          ...
          {step === "form" && (
            <div className="flex flex-col gap-4">
              ...
              <form
                ...
                className="flex flex-col gap-4 text-sm sm:text-xs"
              >
            ...
            <div className="flex flex-col items-center justify-center text-center py-8 gap-4">
              ...
              <div className="flex flex-col gap-1.5 items-center">
                ...
                <p className="text-sm sm:text-xs text-dark/70 dark:text-light/70 max-w-sm leading-relaxed">
                  Thank you for reaching out! Your inquiry has been formatted
                  and delivered to <strong>urvagandhi24@gmail.com</strong>.
                </p>
              </div>
