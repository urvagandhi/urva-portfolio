...
import { GithubIcon } from "@/components/shared/Icons.js";
...
const PROJECTS = [
  ...
  },
  {
    ...
    summary:
      "Built an agentic AI manuscript formatting platform using CrewAI, React 19, Python, and Microsoft Office.js automating compliance checks across APA, IEEE, and Springer standards.",
    description:
      "Developed a 4-agent AI workflow with a 7-dimensional compliance scoring system to streamline academic manuscript submission readiness for researchers.",
  ...
  },
  {
    ...
    summary:
      "Full-stack fleet management platform with 9 modules, 30+ APIs, 4-role RBAC, immutable audit logs, real-time Socket.IO updates, and Docker Compose deployment.",
    description:
      "Engineered scalable backend services with Express.js, TypeScript, PostgreSQL, and Prisma ORM alongside a dynamic React 19 operational dashboard.",
    tech: [
      "TypeScript",
      "Express.js",
      "React 19",
  ...
  },
  {
    ...
    summary:
      "Built a high-performance clinical analytics platform predicting hospital readmissions (30/60/90 days) with Smart Model Loader for instant evaluation.",
    description:
      "Award-winning solution featuring interactive clinical risk visualization dashboards and automated ML model execution.",
  ...
  },
  {
    ...
    summary:
      "Offline PDF analysis engine featuring hierarchical outline extraction and persona-driven document intelligence.",
    description:
      "Parses complex PDF structures locally without external APIs, adapting document insights based on technical vs non-technical user personas.",
  ...
  },
  {
    ...
    summary:
      "AI-driven multi-language vulnerability detection engine using graph-aware transformers to auto-scan code, map flaws to CWE/CVE, and generate explainable security fixes.",
    description:
      "Combines abstract syntax trees with fine-tuned LLMs to deliver deep vulnerability detection and automated remediation.",
    ...
    <div className="w-full flex flex-col items-center">
      ...
      {filteredProjects.length === 0 ? (
        ...
        <>
          ...
          {viewMode === "showcase" && (
            <div
              className={`relative w-full flex flex-col gap-6 rounded-3xl border border-dark/15 bg-gradient-to-br ${activeShowcaseProj.gradient} bg-light/95 dark:border-light/15 dark:bg-dark/95 backdrop-blur-xl p-8 lg:p-5 shadow-2xl overflow-hidden max-w-full`}
            >
              <BorderBeam
                size={300}
                duration={12}
                  ...
                  <div className="col-span-5 lg:col-span-12 flex flex-col justify-between">
                    <div>
                      ...
                      <p className="text-xs font-medium text-dark/80 dark:text-light/80 leading-relaxed mb-4">
                        {activeShowcaseProj.description ||
                          activeShowcaseProj.summary}
                      </p>
              ...
              <div className="flex items-center justify-center gap-3 pt-1 relative z-20">
                ...
                <button
                  onClick={() => {
                    ...
                    const next =
                      filteredProjects[(idx + 1) % filteredProjects.length];
                    setSlideDir(1);
