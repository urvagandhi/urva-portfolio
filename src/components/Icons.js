...
export const CodeChefIcon = ({ className, ...rest }) => (
  ...
  >
    ...
    <path className="fill-[#5d4037] dark:fill-[#bcaaa4] transition-colors duration-300" fillRule="evenodd" d="M32.289,40.61c0.761,4.558-4.809,5.009-7.098,2.95 c-1.583-1.413-1.137-3.381,1.132-3.256C28.327,40.41,29.494,42.984,32.289,40.61" clipRule="evenodd"></path>
    <path className="fill-[#5d4037] dark:fill-[#bcaaa4] transition-colors duration-300" fillRule="evenodd" d="M15.364,40.61c-0.761,4.558,4.809,5.009,7.098,2.95 c1.583-1.413,1.137-3.381-1.132-3.256C19.326,40.41,18.159,42.984,15.364,40.61" clipRule="evenodd"></path>
