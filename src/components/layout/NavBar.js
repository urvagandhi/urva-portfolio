      ...
      <div className="w-full flex justify-between items-center lg:hidden">
        <nav className="flex items-center justify-center gap-8">
          ...
          <CustomLink
            href="#contributions"
            title="Contributions"
            active={isLinkActive("#contributions")}
          />
          <CustomLink
            href="#projects"
            title="Projects"
      ...
      {isOpen && canPortal
        ? createPortal(
            ...
            >
              ...
              <nav
                className="flex items-center justify-center flex-wrap gap-5 mt-6 pt-6 border-t border-light/10 dark:border-dark/10 w-full"
                aria-label="Social media links"
              >
                <motion.a
                  href="https://x.com/urva_gandhi"
