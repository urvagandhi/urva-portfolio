...
import { Slot } from "@/vendor/animate-ui/primitives/animate/slot";

const [LocalCursorProvider, useCursor] = getStrictContext("CursorContext");
...
function CursorContainer({ ref, asChild = false, ...props }) {
