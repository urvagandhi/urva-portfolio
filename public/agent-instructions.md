# AI Agent Instructions for Urva Yogeshkumar Gandhi's Portfolio
...
1. **Machine Discovery:** Inspect `https://urvagandhi.tech/llms.txt` or `/.well-known/mcp` for available capabilities.
...
3. **MCP Tool Calling:** Make HTTP POST requests to `https://urvagandhi.tech/api/mcp` using JSON-RPC 2.0 (`initialize`, `tools/list`, `tools/call`).
...
- Phone: +91-8866241204
- Primary Domain: https://urvagandhi.tech
- Lifetime Domain Mirror: https://urvagandhi-portfolio.vercel.app
